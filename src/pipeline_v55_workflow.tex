...
\node[stage] (c6) at (28.4,18.9) {%
  ...
  \m{hit69\_...v55} (83{,}260{,}466 entries)};
...
\node[panel, text width=13.7cm, minimum height=6.9cm] (p1) at (0.6,13.7) {%
  ...
  static map is excluded --- real clusters are uncorrected and layer-locked, and the
  ...
  \m{rowdr} (export only --- \bd{not} injected) & $+1.2\ldots0.4$\,mm
    & real layer radii vs GDML nominal\\
  \end{tabular}\\[4pt]
...
\node[panel, text width=11.1cm, minimum height=6.9cm] (p3) at (27.5,13.7) {%
  ...
  field amplitudes. The two \color{warn}amber\color{sub}{} entries are the same
